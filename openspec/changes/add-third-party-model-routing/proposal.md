...
- Affected code: `app/core/config/settings.py`, new provider routing/client modules, `app/modules/proxy/api.py`, `app/modules/proxy/request_policy.py`, `app/modules/proxy/service.py`, request-log models/repositories/migrations, settings/dashboard surfaces if runtime management is added, and proxy compatibility tests
