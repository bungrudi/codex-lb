...
const EXPECTED_ENDPOINTS = [
	...
	"PUT /api/accounts/:accountId/periodic-warmup",
	...
	"PUT /api/settings/external-model-routing/routes/:publicModel",
	"DELETE /api/settings/external-model-routing/routes/:publicModel",
