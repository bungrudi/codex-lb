...
def to_request_log_entry(log: RequestLog, *, api_key_name: str | None = None) -> RequestLogEntry:
    ...
    return RequestLogEntry(
        ...
        external_provider_id=log.external_provider_id,
        external_provider_model=log.external_provider_model,
        external_route_public_model=log.external_route_public_model,
        external_route_endpoint=log.external_route_endpoint,
        external_fallback_used=log.external_fallback_used,
        external_fallback_reason=log.external_fallback_reason,
